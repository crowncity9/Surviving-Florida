# Reader Start Checklist

Welcome to **Surviving Florida**. Use this short path to enter Palm Haven without missing the essentials.
...
- [ ] Use the previous and next buttons to keep chapters in order.
- [ ] Check the [character profiles](https://crowncity9.github.io/Surviving-Florida/characters.html) when you need a reminder about a person, role, or faction.
- [ ] Visit the [Palm Haven location archive](https://crowncity9.github.io/Surviving-Florida/locations.html) to understand where the major events happen.
- [ ] Return to the reader on the same device to continue with your saved chapter and preferences.
...
If you only choose one thing, [start with Chapter One](https://crowncity9.github.io/Surviving-Florida/read.html#chapter-1).
